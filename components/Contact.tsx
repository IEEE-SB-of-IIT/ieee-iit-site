...
const Contact = () => {
  ...
  const inputClassName =
    "w-full px-4 py-4 bg-white/40 border border-white/50 rounded-xl text-ieee-dark placeholder:text-ieee-dark/40 focus:outline-none focus:ring-2 focus:ring-ieee-medium/20 focus:border-ieee-medium transition-all";

  return (
    <section
      id="contact"
      className="pb-32 bg-gradient-to-b from-transparent to-ieee-light/5"
    >
      <Container>
        ...
        <div className="mt-20 grid grid-cols-1 lg:grid-cols-2 gap-8 items-stretch">
          ...
          <div className="grid grid-cols-6 gap-6">
            ...
            <Badge className="border-1 border-white col-span-3 rounded-2xl flex flex-col justify-center items-center">
            ...
            <Badge className="border border-white col-span-3 rounded-2xl flex flex-col justify-center items-center">
              <div className="flex items-center gap-4">
            ...
            <Badge className="border border-white col-span-6 rounded-2xl flex flex-col justify-center items-center">
              <div className="flex items-center gap-4">
            ...
            {/* Row 4: Map */}
            <Badge className="border border-white col-span-6 p-0 overflow-hidden min-h-[300px] flex-1 rounded-2xl">
              <iframe
          ...
          <Badge className="border border-white flex flex-col h-full !justify-start p-10 rounded-2xl">
            <div className="mb-10">
              <h3 className="text-2xl font-bold text-ieee-gray mb-2">
                Let’s Connect
              </h3>
            ...
            >
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="space-y-3">
                  <label
                    htmlFor="name-bento"
                    className="block text-ieee-gray/80 font-bold text-sm uppercase tracking-wider ml-1"
                  >
                    Your Name
                  </label>
                  <input
              ...
              <div className="space-y-3 flex-1 flex flex-col">
                ...
                <textarea
                  ...
                  className={cn(
                    inputClassName,
                    "resize-none flex-1 min-h-[100px]"
                  )}
                ></textarea>
              </div>
