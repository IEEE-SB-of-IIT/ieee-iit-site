...
const cardData: BentoCardProps[] = [
  {
    ...
    label: "IEEE RAS of IIT",
    image: "/images/micromaze2.0.png",
  },
  {
    color: "#060010",
    title: "Coderally 6.0",
    description: "Hackathon",
    label: "IEEE CS of IIT",
    image: "/images/1.png",
  },
  {
    color: "#060010",
    title: "CodeSprintX",
    description: "Inter University Startup Battle",
    label: "IEEE of IIT",
    image: "/images/codesprintx.png",
  },
  {
    color: "#060010",
    title: "IX25",
  ...
  },
  {
    color: "#060010",
    title: "SyncUP",
    description: "Mentorship & Growth Program",
    label: "IEEE WIE of IIT",
    image: "/images/1.png",
  },
  {
    color: "#060010",
    title: "PRESTIGE",
    description: "AI Knowledge Forum",
    label: "IEEE CIS of IIT",
    image: "/images/1.png",
  },
];
...
const BentoCardGrid: React.FC<{
  ...
  <div
    className="bento-section grid gap-2 p-0 w-full max-w-none select-none relative"
                  ...
                  <div className="card__content flex flex-col relative text-white">
                    {card.image && (
                      <img
                        ...
                        className="card__image w-full object-cover rounded-md mb-2"
                        style={
                          card.title === "CodeSprintX" || card.title === "IX25"
                            ? { height: "363px" }
                            : {}
                        }
                      />
                ...
                <div className="card__content flex flex-col relative text-white">
                  {card.image && (
                    <img
                      src={card.image}
                      alt={card.title || "Card image"}
                      className="card__image w-full h-24 object-cover rounded-md mb-2"
                    />
                  )}
                  <h3
                    className={`card__title font-normal text-base m-0 mb-1 ${
